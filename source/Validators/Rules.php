...
class Rules
{
     ...
     * @return Errors
     */
    public function validate(array $items): Errors
    {
        $errors = new Errors;
        foreach ($this->rulesToApply as $field => $ruleString) {
    ...
    {
        return (new Formatter)->replace($message ?? "", $updates);
    }
}
